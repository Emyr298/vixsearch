...
use crate::{errcode::FATAL_ERROR, storage::WormReader, utils::vixerr::Error};

pub struct WormFileReader {
    file: Arc<File>,
}

impl WormFileReader {
    pub fn new(file: Arc<File>) -> Box<dyn WormReader> {
        Box::new(Self {
            file,
        })
    }
...
impl WormReader for WormFileReader {
