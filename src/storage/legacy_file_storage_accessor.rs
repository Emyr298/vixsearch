...
use crate::{errcode::FATAL_ERROR, storage::LegacyStorageAccessor, utils::vixerr::Error};

pub struct LegacyFileStorageAccessor {
    file: Arc<File>,
}

impl LegacyFileStorageAccessor {
    pub fn new(file: Arc<File>) -> Box<dyn LegacyStorageAccessor> {
        Box::new(Self {
            file,
        })
    }
...
impl LegacyStorageAccessor for LegacyFileStorageAccessor {
